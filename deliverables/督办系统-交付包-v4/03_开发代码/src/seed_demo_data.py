...
def main():
    ...
    admin_id = models.create_user(
        username='admin',
        display_name='管理员',
        password_hash=generate_password_hash('Supv#Admin2026'),
        role='admin'
    )
    print(f'  管理员 admin/Supv#Admin2026 (ID: {admin_id})')
    ...
    sun_id = models.create_user('sunqi', '孙七', generate_password_hash('Supv#Owner2026'), 'owner')
    zhou_id = models.create_user('zhouba', '周八', generate_password_hash('Supv#Owner2026'), 'owner')
    wu_id = models.create_user('wujiu', '吴九', generate_password_hash('Supv#Owner2026'), 'owner')
    zheng_id = models.create_user('zhengshi', '郑十', generate_password_hash('Supv#Owner2026'), 'owner')
    print(f'  负责人: 张三/李四/王五/赵六/孙七/周八/吴九/郑十 (密码均为 Supv#Owner2026)')
    ...
    print()
    print('登录账号：')
    print(f'  管理员: admin / Supv#Admin2026')
    print(f'  负责人: zhangsan / Supv#Owner2026')
    print(f'  负责人: lisi / Supv#Owner2026')
    print(f'  负责人: wangwu / Supv#Owner2026')
    print(f'  负责人: zhaoliu / Supv#Owner2026')
    print(f'  负责人: sunqi / Supv#Owner2026')
    print(f'  负责人: zhouba / Supv#Owner2026')
    print(f'  负责人: wujiu / Supv#Owner2026')
    print(f'  负责人: zhengshi / Supv#Owner2026')
    print()
